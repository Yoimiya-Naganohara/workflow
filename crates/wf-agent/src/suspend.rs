...
mod tests {
    ...
    fn make_request(budget: u64) -> SpawnRequest {
        SpawnRequest {
            ...
            span_id: 0,
            parent_span_id: 0,
            task_description_embedding: [0.0f32; wf_core::EMBEDDING_DIM],
            role_description_embedding: [0.0f32; wf_core::EMBEDDING_DIM],
            value_statement_embedding: [0.0f32; wf_core::EMBEDDING_DIM],
